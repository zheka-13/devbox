...
Для сервиса выбран язык РНР и фреймворк Lumen. Такой вібр сделан потому что этот язык я знаю лучше всего.
...
Оптимизация оставляет желать лучшего, поэтому все еще остается куча возможностей для нее.
Например, оптимизировать проход, что бы не проверять заведомо занятое место на листе.
Можно уйти от ООП в фунции - скорость вырастет, ресурсов надо будет меньше, код станет менее понятным.
